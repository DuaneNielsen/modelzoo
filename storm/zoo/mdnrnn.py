...
from zoo.losses import Lossable
...
class MDNRNNLoss(Lossable):
    def __init__(self):
        super().__init__()

    def forward(self, y, pi, mu, sigma, context):
        hn, cn = context
        return MDNRNN.loss_fn(y, pi, mu, sigma)
